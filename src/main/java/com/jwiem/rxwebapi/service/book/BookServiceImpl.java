...
import com.jwiem.rxwebapi.entity.Book;
...
public class BookServiceImpl implements BookService {
  ...
  @Override public Single<String> addBook(AddBookRequest addBookRequest) {
    return saveBookRepository(addBookRequest);
  }

  private Single<String> saveBookRepository(AddBookRequest addBookRequest) {
    return Single.create(singleEmitter -> {
      ...
      if (!optionalAuthor.isPresent()) {
        ...
        singleEmitter.onSuccess(addedBookId);
      }
    });
  }

  // We should make use of a builder class here...
  ...
  @Override public Completable updateBook(UpdateBookRequest updateBookRequest) {
    return updateBookRepository(updateBookRequest);
  }

  private Completable updateBookRepository(UpdateBookRequest updateBookRequest) {
  ...
  @Override public Single<List<BookResponse>> getAllBooks(int limit, int page) {
  ...
  @Override public Single<BookResponse> getBookDetail(String id) {
  ...
  @Override public Completable deleteBook(String id) {
